...
| 新聞搜尋 | [Anspire](https://open.anspire.cn/?share_code=QFBC0FYC)、[SerpAPI](https://serpapi.com/baidu-search-api?utm_source=github_daily_stock_analysis)、[Tavily](https://tavily.com/)、[Bocha](https://open.bochaai.com/)、[百度千帆 AI 搜尋](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u)、[Brave](https://brave.com/search/api/)、[MiniMax](https://platform.minimaxi.com/)、SearXNG |
...
| `BOCHA_API_KEYS` | [博查搜尋](https://open.bochaai.com/)：中文搜尋優化，支援 AI 摘要 | 可選 |
| `BAIDU_AI_SEARCH_API_KEYS` | [百度千帆 AI 搜尋](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u)：百度搜尋 v2，補充 A 股中文網頁與輿情召回 | 可選 |
