...
| News Search | [Anspire](https://open.anspire.cn/?share_code=QFBC0FYC), [SerpAPI](https://serpapi.com/baidu-search-api?utm_source=github_daily_stock_analysis), [Tavily](https://tavily.com/), [Bocha](https://open.bochaai.com/), [Baidu Qianfan AI Search](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u), [Brave](https://brave.com/search/api/), [MiniMax](https://platform.minimaxi.com/), SearXNG |
...
| `BOCHA_API_KEYS` | [Bocha](https://open.bochaai.com/), Chinese search with AI summaries | Optional |
| `BAIDU_AI_SEARCH_API_KEYS` | [Baidu Qianfan AI Search](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u), Baidu Search v2 for Chinese and A-share web recall | Optional |
