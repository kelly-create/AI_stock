...
| 新闻搜索 | [Anspire](https://open.anspire.cn/dsa/?share_code=QFBC0FYC)、[SerpAPI](https://serpapi.com/baidu-search-api?utm_source=github_daily_stock_analysis)、[Tavily](https://tavily.com/)、[Bocha](https://open.bochaai.com/)、[百度千帆 AI 搜索](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u)、[Brave](https://brave.com/search/api/)、[MiniMax](https://platform.minimaxi.com/)、SearXNG |
...
| `BOCHA_API_KEYS` | [博查搜索](https://open.bochaai.com/)：中文搜索优化，支持 AI 摘要 | 可选 |
| `BAIDU_AI_SEARCH_API_KEYS` | [百度千帆 AI 搜索](https://cloud.baidu.com/doc/qianfan-api/s/Hmbu8m06u)：百度搜索 v2，补充 A 股中文网页与舆情召回 | 可选 |
