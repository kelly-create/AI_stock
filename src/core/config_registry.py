...
SCHEMA_VERSION = "2026-08-08-production-runtime-config"
...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "Staged rollout controls for the personal A-share research system.",
        "display_order": 57,
    },
    {
        "category": "backtest",
...
_PERSONAL_RESEARCH_DOCS = [
    {
        "label": "个人 A 股投研迁移与功能开关",
        "href": "https://github.com/kelly-create/AI_stock/blob/main/docs/personal-research-rollout.md",
    },
]

_DATA_SOURCE_RUNTIME_DOCS = [
    {
        "label": "数据源运行时配置",
        "href": "https://github.com/kelly-create/AI_stock/blob/main/docs/full-guide.md#数据源配置",
    },
]

_DECISION_SIGNAL_DOCS = [
    {
        "label": "Decision Signal 运维说明",
        "href": "https://github.com/kelly-create/AI_stock/blob/main/docs/decision-signals.md",
    },
]
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_PRIORITY": {
        ...
        "description": (
            "Optional daily-data provider priority (0-99; lower is earlier). "
            "Leave blank to preserve token-driven automatic priority."
        ),
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        ...
        "display_order": 11,
        "help_key": "settings.data_source.TUSHARE_PRIORITY",
        "examples": [
            "TUSHARE_PRIORITY=",
            "TUSHARE_PRIORITY=0",
        ],
        "docs": _DATA_SOURCE_RUNTIME_DOCS,
        "warning_codes": [],
    },
    "FUNDAMENTAL_AUXILIARY_TIMEOUT_SECONDS": {
        "title": "Fundamental Auxiliary Timeout",
        "description": (
            "Timeout in seconds for optional auxiliary fundamental sources so "
            "they cannot consume the entire fundamental stage budget."
        ),
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        ...
        "validation": {"min": 0.0},
        "display_order": 12,
        "help_key": "settings.data_source.FUNDAMENTAL_AUXILIARY_TIMEOUT_SECONDS",
        "examples": [
            "FUNDAMENTAL_AUXILIARY_TIMEOUT_SECONDS=4.0",
            "FUNDAMENTAL_AUXILIARY_TIMEOUT_SECONDS=0",
        ],
        "docs": _DATA_SOURCE_RUNTIME_DOCS,
        "warning_codes": [],
    },
    ...
    "PERSONAL_RESEARCH_ENABLED": {
        "title": "Personal Research",
        "description": "Master switch for the staged personal A-share research capabilities.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 10,
        "help_key": "settings.research.rollout",
        "examples": ["PERSONAL_RESEARCH_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "DURABLE_JOBS_ENABLED": {
        "title": "Durable Analysis Jobs",
        "description": "Enable the SQLite-backed durable analysis job path independently of research output features.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 20,
        "help_key": "settings.research.rollout",
        "examples": ["DURABLE_JOBS_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "TUSHARE_RESEARCH_ENABLED": {
        "title": "Tushare Research Data",
        "description": "Enable durable Tushare research datasets; requires Personal Research and Durable Jobs.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 30,
        "help_key": "settings.research.rollout",
        "examples": ["TUSHARE_RESEARCH_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "TUSHARE_GLOBAL_CALLS_PER_MINUTE": {
        "title": "Tushare Account Calls Per Minute",
        "description": "Account-wide rolling request-start cap. Values may only tighten the hard 450 calls/minute ceiling.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "450",
        "options": [],
        "validation": {"min": 1, "max": 450},
        "display_order": 31,
        "help_key": "settings.research.tushare_quota",
        "examples": ["TUSHARE_GLOBAL_CALLS_PER_MINUTE=450"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "TUSHARE_MAX_INFLIGHT": {
        "title": "Tushare Maximum In-flight Requests",
        "description": "Hard process-wide concurrent Tushare transport limit; production research supports at most two.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 32,
        "help_key": "settings.research.tushare_quota",
        "examples": ["TUSHARE_MAX_INFLIGHT=2"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "TUSHARE_ENDPOINT_LIMITS_JSON": {
        "title": "Tushare Endpoint Limits",
        "description": "Optional JSON object of per-endpoint calls/minute limits. Endpoint buckets only tighten the account-wide cap.",
        "category": "research",
        "data_type": "json",
        "ui_control": "textarea",
        "is_sensitive": False,
        ...
        "display_order": 33,
        "help_key": "settings.research.tushare_quota",
        "examples": ['TUSHARE_ENDPOINT_LIMITS_JSON={"cyq_chips":200}'],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_FACTORS_ENABLED": {
        "title": "Deterministic Research Factors",
        "description": "Enable deterministic factor snapshots after Tushare research data is enabled.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 40,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_FACTORS_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_EVIDENCE_ENABLED": {
        "title": "Research Evidence Chain",
        "description": "Enable evidence and claim validation after deterministic factors are enabled.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 50,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_EVIDENCE_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_DEBATE_ENABLED": {
        "title": "Bounded Research Debate",
        "description": "Enable evidence-bound Bull/Bear debate after the evidence chain is enabled.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 60,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_DEBATE_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_THESIS_ENABLED": {
        "title": "Versioned Research Thesis",
        "description": "Enable immutable thesis versions after the evidence chain is enabled.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 70,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_THESIS_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "DECISION_OUTCOME_V2_ENABLED": {
        "title": "Decision Outcome v2",
        "description": "Enable the v2 decision outcome evaluator after deterministic factors are enabled.",
        "category": "research",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 80,
        "help_key": "settings.research.rollout",
        "examples": ["DECISION_OUTCOME_V2_ENABLED=false"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "DECISION_OUTCOME_V2_INTERVAL_MINUTES": {
        "title": "Decision Outcome v2 Interval",
        "description": "Minutes between durable Outcome v2 maintenance submissions.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 81,
        "help_key": "settings.research.rollout",
        "examples": ["DECISION_OUTCOME_V2_INTERVAL_MINUTES=60"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "DECISION_OUTCOME_V2_BATCH_LIMIT": {
        "title": "Decision Outcome v2 Batch Limit",
        "description": "Maximum signal and horizon identities advanced by one durable job.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 82,
        "help_key": "settings.research.rollout",
        "examples": ["DECISION_OUTCOME_V2_BATCH_LIMIT=100"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "PORTFOLIO_POLICY_GATE_MODE": {
        "title": "Portfolio Policy Gate",
        "description": "Keep off, observe would-block decisions in shadow, or enforce the deterministic policy gate.",
        "category": "research",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["off", "shadow", "enforce"]},
        "display_order": 90,
        "help_key": "settings.research.policy_gate",
        "examples": ["PORTFOLIO_POLICY_GATE_MODE=off"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_QUICK_DAILY_BUDGET": {
        "title": "Quick Research Daily Budget",
        "description": "Maximum daily Quick reservations. Set 0 for unlimited personal use. Manual override changes this counter only; it never bypasses leases or concurrency.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 100,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_QUICK_DAILY_BUDGET=50", "RESEARCH_QUICK_DAILY_BUDGET=0"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_STANDARD_DEEP_DAILY_BUDGET": {
        "title": "Standard and Deep Research Daily Budget",
        "description": "Shared daily reservation budget for Standard and Deep research runs. Set 0 for unlimited personal use.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 110,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_STANDARD_DEEP_DAILY_BUDGET=20", "RESEARCH_STANDARD_DEEP_DAILY_BUDGET=0"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_DEBATE_DAILY_BUDGET": {
        "title": "Debate Daily Budget",
        "description": "Maximum daily evidence-bound Debate reservations. Set 0 for unlimited personal use.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 120,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_DEBATE_DAILY_BUDGET=8", "RESEARCH_DEBATE_DAILY_BUDGET=0"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    ...
    "DECISION_SIGNAL_OUTCOME_ENABLED": {
        ...
        "description": (
            "Enable periodic evaluation of matured decision-signal-v1 outcomes "
            "under the single schedule owner."
        ),
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
    ...
    "DECISION_SIGNAL_OUTCOME_BATCH_LIMIT": {
        ...
        "description": "Maximum number of matured signals evaluated in one maintenance pass.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "examples": [
            ...
            "DECISION_SIGNAL_OUTCOME_BATCH_LIMIT=50",
        ],
        "docs": _DECISION_SIGNAL_DOCS,
        "warning_codes": [],
    },
