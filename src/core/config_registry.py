...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "RESEARCH_QUICK_DAILY_BUDGET": {
        ...
        "description": "Maximum daily Quick reservations. Manual override changes this counter only; it never bypasses leases or concurrency.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 100,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_QUICK_DAILY_BUDGET=50"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_STANDARD_DEEP_DAILY_BUDGET": {
        "title": "Standard and Deep Research Daily Budget",
        "description": "Shared daily reservation budget for Standard and Deep research runs.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 110,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_STANDARD_DEEP_DAILY_BUDGET=20"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
    "RESEARCH_DEBATE_DAILY_BUDGET": {
        "title": "Debate Daily Budget",
        "description": "Maximum daily evidence-bound Debate reservations.",
        "category": "research",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 120,
        "help_key": "settings.research.rollout",
        "examples": ["RESEARCH_DEBATE_DAILY_BUDGET=8"],
        "docs": _PERSONAL_RESEARCH_DOCS,
        "warning_codes": [],
    },
